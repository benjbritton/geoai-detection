...
Code, configurations and the full lab notebook are in the repository: **[benjbritton/geoai-detection](https://github.com/benjbritton/geoai-detection)**. All training runs, with their metrics and configurations, are logged at **[wandb.ai/benjbritton-geoai/chactun-multiclass](https://wandb.ai/benjbritton-geoai/chactun-multiclass)**.
